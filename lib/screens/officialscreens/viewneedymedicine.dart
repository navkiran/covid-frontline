...
class ViewNeedMedicines extends StatefulWidget {
  @override
  _ViewNeedMedicinesState createState() => _ViewNeedMedicinesState();
}

class _ViewNeedMedicinesState extends State<ViewNeedMedicines> {
