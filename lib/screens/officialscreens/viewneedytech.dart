...
class ViewNeedTechnicalService extends StatefulWidget {
  @override
  _ViewNeedTechnicalServiceState createState() =>
      _ViewNeedTechnicalServiceState();
}

class _ViewNeedTechnicalServiceState extends State<ViewNeedTechnicalService> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text('Requests for Technical Services'),
...
class InfoTile extends StatefulWidget {
  final String name, contact, state, district, address, need, category;
